import { BrainCircuit, FileOutput, FileType, MoveRight } from "lucide-react";
...
const steps: Step[] = [
  {
    icon: <FileType size={64} strokeWidth={1.5} />,
  ...
  },
  {
    ...
    label: "Get Summary",
    description:
      "Receive a concise summary of your document, highlighting key points",
  },
];
    ...
    <section className="relative overflow-hidden bg-gray-50">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="font-black text-xl uppercase mb-4 text-rose-500">
            How it works
          </h2>
  ...
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/5 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-rose-500/10 to-transparent group-hover:bg-linear-to-br group-hover:from-rose-500/20 transition-colors">
